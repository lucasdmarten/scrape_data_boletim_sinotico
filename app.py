...
def create_response_lists():
    ...
    prev96 = list()
    prev120 = list()
    return dates, text_data, url_data, level_data, prev24, prev48, prev72, prev96, prev120

def append_response_lists(dates, text_data, url_data, level_data, prev24, prev48, prev72, prev96, prev120):
...
def make_response(dates, text_data, url_data, level_data, prev24, prev48, prev72, prev96, prev120):
    return {
            "dates":dates,
            "text_data":text_data,
            "url_data":url_data,
...
if __name__ == "__main__":
    ...
    for date_obj in gen_list_dates('20090101T00', '20091231T12'):
        ...
        dates, text_data, url_data, level_data, prev24, prev48, prev72, prev96, prev120 = create_response_lists()
        ...
        for i, data in enumerate(texts):
            ...
            if data.find('a'):
                ...
                text = data.text
                append_response_lists(dates, text_data, url_data, level_data, prev24, prev48, prev72, prev96, prev120)

        os.system(f"mkdir -p ./data/{date_obj.strftime('%Y')}/")
        
        response = make_response(dates, text_data, url_data, level_data, prev24, prev48, prev72, prev96, prev120)
